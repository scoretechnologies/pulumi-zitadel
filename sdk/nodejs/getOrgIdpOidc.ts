 ...
 *
 * const _default = zitadel.getOrgIdpOidc({
 *     orgId: defaultZitadelOrg.id,
 *     id: "123456789012345678",
 * });
 * export const orgIdpOidc = _default;
 * ```
 */
export function getOrgIdpOidc(args: GetOrgIdpOidcArgs, opts?: pulumi.InvokeOptions): Promise<GetOrgIdpOidcResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("zitadel:index/getOrgIdpOidc:getOrgIdpOidc", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
 ...
 */
export interface GetOrgIdpOidcArgs {
    /**
 ...
 */
export interface GetOrgIdpOidcResult {
    /**
 ...
 * ```
 */
export function getOrgIdpOidcOutput(args: GetOrgIdpOidcOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpOidcResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpOidc:getOrgIdpOidc", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
 ...
 * A collection of arguments for invoking getOrgIdpOidc.
 */
export interface GetOrgIdpOidcOutputArgs {
    /**
     * The ID of this resource.
     */
