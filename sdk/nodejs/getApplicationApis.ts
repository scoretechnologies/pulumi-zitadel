 ...
 * ## Example Usage
 */
export function getApplicationApisOutput(args: GetApplicationApisOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationApisResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getApplicationApis:getApplicationApis", {
        "name": args.name,
        "nameMethod": args.nameMethod,
        "orgId": args.orgId,
        "projectId": args.projectId,
