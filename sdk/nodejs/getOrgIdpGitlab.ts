 ...
 *
 * const _default = zitadel.getOrgIdpGitlab({
 ...
 * ```
 */
export function getOrgIdpGitlabOutput(args: GetOrgIdpGitlabOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpGitlabResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpGitlab:getOrgIdpGitlab", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
