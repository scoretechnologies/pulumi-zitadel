 ...
 *
 * const _default = zitadel.getIdpGitlabSelfHosted({
 ...
 * ```
 */
export function getIdpGitlabSelfHostedOutput(args: GetIdpGitlabSelfHostedOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpGitlabSelfHostedResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpGitlabSelfHosted:getIdpGitlabSelfHosted", {
        "id": args.id,
    }, opts);
}
