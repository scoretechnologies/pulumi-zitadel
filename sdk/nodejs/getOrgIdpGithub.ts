 ...
 *
 * const _default = zitadel.getOrgIdpGithub({
 ...
 * ```
 */
export function getOrgIdpGithubOutput(args: GetOrgIdpGithubOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpGithubResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpGithub:getOrgIdpGithub", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
