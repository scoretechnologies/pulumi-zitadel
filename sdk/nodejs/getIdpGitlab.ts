 ...
 *
 * const _default = zitadel.getIdpGitlab({
 ...
 * ```
 */
export function getIdpGitlabOutput(args: GetIdpGitlabOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpGitlabResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpGitlab:getIdpGitlab", {
        "id": args.id,
    }, opts);
}
