 ...
 *
 * const _default = zitadel.getOrgIdpGithubEs({
 ...
 * ```
 */
export function getOrgIdpGithubEsOutput(args: GetOrgIdpGithubEsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpGithubEsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpGithubEs:getOrgIdpGithubEs", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
