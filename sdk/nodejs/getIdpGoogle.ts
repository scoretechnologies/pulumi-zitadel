 ...
 *
 * const _default = zitadel.getIdpGoogle({
 ...
 * ```
 */
export function getIdpGoogleOutput(args: GetIdpGoogleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpGoogleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpGoogle:getIdpGoogle", {
        "id": args.id,
    }, opts);
}
