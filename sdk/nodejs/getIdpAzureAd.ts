 ...
 *
 * const _default = zitadel.getIdpAzureAd({
 ...
 * ```
 */
export function getIdpAzureAdOutput(args: GetIdpAzureAdOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpAzureAdResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpAzureAd:getIdpAzureAd", {
        "id": args.id,
    }, opts);
}
