 ...
 *
 * const _default = zitadel.getOrgIdpGitlabSelfHosted({
 ...
 * ```
 */
export function getOrgIdpGitlabSelfHostedOutput(args: GetOrgIdpGitlabSelfHostedOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpGitlabSelfHostedResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpGitlabSelfHosted:getOrgIdpGitlabSelfHosted", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
