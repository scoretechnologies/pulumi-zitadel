 ...
 * ## Example Usage
 */
export function getOrgJwtIdpOutput(args: GetOrgJwtIdpOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgJwtIdpResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgJwtIdp:getOrgJwtIdp", {
        "idpId": args.idpId,
        "orgId": args.orgId,
    }, opts);
}
