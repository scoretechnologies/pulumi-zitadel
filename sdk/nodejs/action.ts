...
export class Action extends pulumi.CustomResource {
     ...
     */
    declare public readonly allowedToFail: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: ActionArgs | ActionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["allowedToFail"] = state?.allowedToFail;
            ...
            if (args?.allowedToFail === undefined && !opts.urn) {
            ...
            resourceInputs["allowedToFail"] = args?.allowedToFail;
...
export interface ActionState {
     ...
     * when true, the next action will be called even if this action fails
     */
    allowedToFail?: pulumi.Input<boolean | undefined>;
