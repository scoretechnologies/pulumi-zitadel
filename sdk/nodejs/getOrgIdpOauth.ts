 ...
 *
 * const _default = zitadel.getOrgIdpOauth({
 ...
 * ```
 */
export function getOrgIdpOauthOutput(args: GetOrgIdpOauthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpOauthResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpOauth:getOrgIdpOauth", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
