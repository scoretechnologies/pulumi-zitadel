 ...
 *
 * const _default = zitadel.getIdpOauth({
 ...
 * ```
 */
export function getIdpOauthOutput(args: GetIdpOauthOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpOauthResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpOauth:getIdpOauth", {
        "id": args.id,
    }, opts);
}
