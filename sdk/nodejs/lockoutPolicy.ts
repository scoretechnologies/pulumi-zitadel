...
export class LockoutPolicy extends pulumi.CustomResource {
     ...
     */
    declare public readonly maxOtpAttempts: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly maxPasswordAttempts: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: LockoutPolicyArgs | LockoutPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["maxOtpAttempts"] = state?.maxOtpAttempts;
            resourceInputs["maxPasswordAttempts"] = state?.maxPasswordAttempts;
            resourceInputs["orgId"] = state?.orgId;
        } else {
            const args = argsOrState as LockoutPolicyArgs | undefined;
            if (args?.maxPasswordAttempts === undefined && !opts.urn) {
                throw new Error("Missing required property 'maxPasswordAttempts'");
            }
            resourceInputs["maxOtpAttempts"] = args?.maxOtpAttempts;
            resourceInputs["maxPasswordAttempts"] = args?.maxPasswordAttempts;
...
export interface LockoutPolicyState {
     ...
     * Maximum OTP check attempts before the account gets locked. Attempts are reset as soon as the OTP is entered correct.
     */
    maxOtpAttempts?: pulumi.Input<number | undefined>;
    /**
     * Maximum password check attempts before the account gets locked. Attempts are reset as soon as the password is entered correct or the password is reset.
     */
    maxPasswordAttempts?: pulumi.Input<number | undefined>;
    /**
     * ID of the organization. If not provided, the organization of the authenticated user/service account is used.
     */
