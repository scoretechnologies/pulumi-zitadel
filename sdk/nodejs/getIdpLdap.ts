 ...
 *
 * const _default = zitadel.getIdpLdap({
 ...
 * ```
 */
export function getIdpLdapOutput(args: GetIdpLdapOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpLdapResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpLdap:getIdpLdap", {
        "id": args.id,
    }, opts);
}
