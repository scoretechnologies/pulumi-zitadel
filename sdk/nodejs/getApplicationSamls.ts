 ...
 * ## Example Usage
 */
export function getApplicationSamlsOutput(args: GetApplicationSamlsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApplicationSamlsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getApplicationSamls:getApplicationSamls", {
        "name": args.name,
        "nameMethod": args.nameMethod,
        "orgId": args.orgId,
        "projectId": args.projectId,
