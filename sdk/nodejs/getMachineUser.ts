 ...
 *
 * const _default = zitadel.getMachineUser({
 ...
 * ```
 */
export function getMachineUserOutput(args: GetMachineUserOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMachineUserResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getMachineUser:getMachineUser", {
        "orgId": args.orgId,
        "userId": args.userId,
    }, opts);
}
