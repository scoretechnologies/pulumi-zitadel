 ...
 *
 * const _default = zitadel.getIdpGithubEs({
 ...
 * ```
 */
export function getIdpGithubEsOutput(args: GetIdpGithubEsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdpGithubEsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getIdpGithubEs:getIdpGithubEs", {
        "id": args.id,
    }, opts);
}
