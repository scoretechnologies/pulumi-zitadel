...
export class DefaultOidcSettings extends pulumi.CustomResource {
     ...
     */
    declare public readonly accessTokenLifetime: pulumi.Output<string>;
    /**
     * lifetime duration of id tokens
     */
    declare public readonly idTokenLifetime: pulumi.Output<string>;
    /**
     * expiration duration of refresh tokens
     */
    declare public readonly refreshTokenExpiration: pulumi.Output<string>;
    /**
     * expiration duration of idle refresh tokens
     */
    declare public readonly refreshTokenIdleExpiration: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: DefaultOidcSettingsArgs | DefaultOidcSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["accessTokenLifetime"] = state?.accessTokenLifetime;
            resourceInputs["idTokenLifetime"] = state?.idTokenLifetime;
            resourceInputs["refreshTokenExpiration"] = state?.refreshTokenExpiration;
            resourceInputs["refreshTokenIdleExpiration"] = state?.refreshTokenIdleExpiration;
        } else {
            const args = argsOrState as DefaultOidcSettingsArgs | undefined;
            if (args?.accessTokenLifetime === undefined && !opts.urn) {
                throw new Error("Missing required property 'accessTokenLifetime'");
            }
            if (args?.idTokenLifetime === undefined && !opts.urn) {
                throw new Error("Missing required property 'idTokenLifetime'");
            }
            if (args?.refreshTokenExpiration === undefined && !opts.urn) {
                throw new Error("Missing required property 'refreshTokenExpiration'");
            }
            if (args?.refreshTokenIdleExpiration === undefined && !opts.urn) {
                throw new Error("Missing required property 'refreshTokenIdleExpiration'");
            }
            resourceInputs["accessTokenLifetime"] = args?.accessTokenLifetime;
            resourceInputs["idTokenLifetime"] = args?.idTokenLifetime;
            resourceInputs["refreshTokenExpiration"] = args?.refreshTokenExpiration;
            resourceInputs["refreshTokenIdleExpiration"] = args?.refreshTokenIdleExpiration;
        }
...
export interface DefaultOidcSettingsState {
     ...
     * lifetime duration of id tokens
     */
    idTokenLifetime?: pulumi.Input<string | undefined>;
    /**
     * expiration duration of refresh tokens
     */
     ...
     * expiration duration of idle refresh tokens
     */
    refreshTokenIdleExpiration?: pulumi.Input<string | undefined>;
}
