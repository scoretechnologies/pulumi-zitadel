 ...
 *
 * const _default = zitadel.getOrgIdpGoogle({
 ...
 * ```
 */
export function getOrgIdpGoogleOutput(args: GetOrgIdpGoogleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgIdpGoogleResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("zitadel:index/getOrgIdpGoogle:getOrgIdpGoogle", {
        "id": args.id,
        "orgId": args.orgId,
    }, opts);
}
