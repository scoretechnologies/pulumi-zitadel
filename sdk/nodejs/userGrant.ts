...
export class UserGrant extends pulumi.CustomResource {
     ...
     */
    declare public readonly projectGrantId: pulumi.Output<string | undefined>;
    /**
     * ID of the project
     */
    ...
    constructor(name: string, argsOrState?: UserGrantArgs | UserGrantState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["projectGrantId"] = state?.projectGrantId;
            ...
            resourceInputs["projectGrantId"] = args?.projectGrantId;
