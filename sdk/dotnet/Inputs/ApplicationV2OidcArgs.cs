...
namespace scoretechnologies.Zitadel.Inputs
{
    ...
    public sealed class ApplicationV2OidcArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ApplicationV2OidcComplianceProblemArgs>? _complianceProblems;
        ...
        /// </summary>
        public InputList<Inputs.ApplicationV2OidcComplianceProblemArgs> ComplianceProblems
        {
            get => _complianceProblems ?? (_complianceProblems = new InputList<Inputs.ApplicationV2OidcComplianceProblemArgs>());
        ...
        /// </summary>
        [Input("loginVersion")]
        public Input<Inputs.ApplicationV2OidcLoginVersionArgs>? LoginVersion { get; set; }
        ...
        public ApplicationV2OidcArgs()
        {
        }
        public static new ApplicationV2OidcArgs Empty => new ApplicationV2OidcArgs();
    }
}
