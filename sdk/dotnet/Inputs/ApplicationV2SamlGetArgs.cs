...
namespace scoretechnologies.Zitadel.Inputs
{
    ...
    public sealed class ApplicationV2SamlGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("loginVersion")]
        public Input<Inputs.ApplicationV2SamlLoginVersionGetArgs>? LoginVersion { get; set; }
        ...
        public ApplicationV2SamlGetArgs()
        {
        }
        public static new ApplicationV2SamlGetArgs Empty => new ApplicationV2SamlGetArgs();
    }
}
