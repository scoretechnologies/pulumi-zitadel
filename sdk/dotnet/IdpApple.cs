...
namespace scoretechnologies.Zitadel
{
    ...
    /// {
    ///     var @default = new Zitadel.IdpApple("default", new()
    ///     {
    ///         Name = "Apple",
    ...
    /// ```
    /// </summary>
    [ZitadelResourceType("zitadel:index/idpApple:IdpApple")]
    public partial class IdpApple : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public IdpApple(string name, IdpAppleArgs args, CustomResourceOptions? options = null)
            : base("zitadel:index/idpApple:IdpApple", name, args ?? new IdpAppleArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IdpApple(string name, Input<string> id, IdpAppleState? state = null, CustomResourceOptions? options = null)
            : base("zitadel:index/idpApple:IdpApple", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static IdpApple Get(string name, Input<string> id, IdpAppleState? state = null, CustomResourceOptions? options = null)
        {
            return new IdpApple(name, id, state, options);
        }
    }

    public sealed class IdpAppleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
        /// </summary>
        ...
        public static new IdpAppleArgs Empty => new IdpAppleArgs();
    }

    public sealed class IdpAppleState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable if users should get prompted to link an existing ZITADEL user to an external account if the selected attribute matches, supported values: AUTO*LINKING*OPTION*UNSPECIFIED, AUTO*LINKING*OPTION*USERNAME, AUTO*LINKING*OPTION_EMAIL
        /// </summary>
        ...
        public IdpAppleState()
        {
        }
        public static new IdpAppleState Empty => new IdpAppleState();
    }
}
