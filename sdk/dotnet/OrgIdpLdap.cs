...
namespace scoretechnologies.Zitadel
{
    ...
    public partial class OrgIdpLdap : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("bindPasswordHash")]
        public Output<string> BindPasswordHash { get; private set; } = null!;
    ...
    public sealed class OrgIdpLdapState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("bindPasswordHash")]
        private Input<string>? _bindPasswordHash;

        /// <summary>
        /// A non-reversible hash of the write-only bind_password, used to detect when the password changes. It does not contain the password itself.
        /// </summary>
        public Input<string>? BindPasswordHash
        {
            get => _bindPasswordHash;
            set
            {
                var emptySecret = Output.CreateSecret(0);
                _bindPasswordHash = Output.Tuple<Input<string>?, int>(value, emptySecret).Apply(t => t.Item1);
            }
        }
