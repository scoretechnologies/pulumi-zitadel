...
namespace scoretechnologies.Zitadel
{
    ...
    public partial class IdpSaml : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("federatedLogoutEnabled")]
        public Output<bool?> FederatedLogoutEnabled { get; private set; } = null!;
        ...
        /// </summary>
        [Output("transientMappingAttributeName")]
        public Output<string?> TransientMappingAttributeName { get; private set; } = null!;
    ...
    public sealed class IdpSamlArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// If enabled, ZITADEL will send a logout request to the identity provider when the user terminates the session in ZITADEL. Be sure to provide a SLO endpoint as part of the metadata.
        /// </summary>
        [Input("federatedLogoutEnabled")]
        public Input<bool>? FederatedLogoutEnabled { get; set; }
        ...
        /// Name of the attribute used to map the user in case the nameid-format is `urn:oasis:names:tc:SAML:2.0:nameid-format:transient`.
        /// </summary>
        [Input("transientMappingAttributeName")]
        public Input<string>? TransientMappingAttributeName { get; set; }
