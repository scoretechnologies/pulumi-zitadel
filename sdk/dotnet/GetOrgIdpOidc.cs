...
{
    public static class GetOrgIdpOidc
    {
        /// <summary>
        ...
        /// {
        ///     var @default = Zitadel.GetOrgIdpOidc.Invoke(new()
        ///     {
        ...
        /// ```
        /// </summary>
        public static Task<GetOrgIdpOidcResult> InvokeAsync(GetOrgIdpOidcArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetOrgIdpOidcResult>("zitadel:index/getOrgIdpOidc:getOrgIdpOidc", args ?? new GetOrgIdpOidcArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetOrgIdpOidcResult> Invoke(GetOrgIdpOidcInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrgIdpOidcResult>("zitadel:index/getOrgIdpOidc:getOrgIdpOidc", args ?? new GetOrgIdpOidcInvokeArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetOrgIdpOidcResult> Invoke(GetOrgIdpOidcInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetOrgIdpOidcResult>("zitadel:index/getOrgIdpOidc:getOrgIdpOidc", args ?? new GetOrgIdpOidcInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetOrgIdpOidcArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetOrgIdpOidcArgs()
        {
        }
        public static new GetOrgIdpOidcArgs Empty => new GetOrgIdpOidcArgs();
    }

    public sealed class GetOrgIdpOidcInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The ID of this resource.
        /// </summary>
        ...
        public GetOrgIdpOidcInvokeArgs()
        {
        }
        public static new GetOrgIdpOidcInvokeArgs Empty => new GetOrgIdpOidcInvokeArgs();
    }


    [OutputType]
    public sealed class GetOrgIdpOidcResult
    {
        /// <summary>
