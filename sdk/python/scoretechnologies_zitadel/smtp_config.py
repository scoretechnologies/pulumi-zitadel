...
class SmtpConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of the SMTP configuration.
...
@pulumi.type_token("zitadel:index/smtpConfig:SmtpConfig")
class SmtpConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            set_active: pulumi.Input[Optional[_builtins.bool]] = None,
            tls: pulumi.Input[Optional[_builtins.bool]] = None,
            user: pulumi.Input[Optional[_builtins.str]] = None) -> 'SmtpConfig':
        """
