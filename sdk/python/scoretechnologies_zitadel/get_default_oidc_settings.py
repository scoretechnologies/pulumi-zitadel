...
class GetDefaultOidcSettingsResult:
    ...
    def access_token_lifetime(self) -> _builtins.str:
        """
    ...
    def id_token_lifetime(self) -> _builtins.str:
        """
    ...
    def refresh_token_expiration(self) -> _builtins.str:
        """
    ...
    def refresh_token_idle_expiration(self) -> _builtins.str:
        """
...
def get_default_oidc_settings_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDefaultOidcSettingsResult]:
    """
    Datasource representing the default oidc settings.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getDefaultOidcSettings:getDefaultOidcSettings', __args__, opts=opts, typ=GetDefaultOidcSettingsResult)
    return __ret__.apply(lambda __response__: GetDefaultOidcSettingsResult(
        access_token_lifetime=pulumi.get(__response__, 'access_token_lifetime'),
        id=pulumi.get(__response__, 'id'),
        id_token_lifetime=pulumi.get(__response__, 'id_token_lifetime'),
        refresh_token_expiration=pulumi.get(__response__, 'refresh_token_expiration'),
        refresh_token_idle_expiration=pulumi.get(__response__, 'refresh_token_idle_expiration')))
