...
def get_org_idp_github(id: Optional[_builtins.str] = None,
...
def get_org_idp_github_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                              org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpGithubResult]:
    """
    Datasource representing a GitHub IdP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpGithub:getOrgIdpGithub', __args__, opts=opts, typ=GetOrgIdpGithubResult)
    return __ret__.apply(lambda __response__: GetOrgIdpGithubResult(
