...
class PersonalAccessTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expiration_date: Expiration date of the token in the RFC3339 format
...
class _PersonalAccessTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expiration_date: Expiration date of the token in the RFC3339 format
        :param pulumi.Input[_builtins.str] org_id: ID of the organization. If not provided, the organization of the authenticated user/service account is used.
        :param pulumi.Input[_builtins.str] token: Value of the token
        :param pulumi.Input[_builtins.str] user_id: ID of the user
        """
        if expiration_date is not None:
            pulumi.set(__self__, "expiration_date", expiration_date)
...
@pulumi.type_token("zitadel:index/personalAccessToken:PersonalAccessToken")
class PersonalAccessToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            token: pulumi.Input[Optional[_builtins.str]] = None,
            user_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'PersonalAccessToken':
        """
