...
def get_org_idp_gitlab(id: Optional[_builtins.str] = None,
...
def get_org_idp_gitlab_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                              org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpGitlabResult]:
    """
    Datasource representing a GitLab IdP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpGitlab:getOrgIdpGitlab', __args__, opts=opts, typ=GetOrgIdpGitlabResult)
    return __ret__.apply(lambda __response__: GetOrgIdpGitlabResult(
