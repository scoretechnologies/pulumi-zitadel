...
def get_idp_gitlab(id: Optional[_builtins.str] = None,
...
def get_idp_gitlab_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdpGitlabResult]:
    """
    Datasource representing a GitLab IDP on the instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getIdpGitlab:getIdpGitlab', __args__, opts=opts, typ=GetIdpGitlabResult)
    return __ret__.apply(lambda __response__: GetIdpGitlabResult(
