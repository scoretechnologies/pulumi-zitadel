...
def get_org_jwt_idp(idp_id: Optional[_builtins.str] = None,
...
def get_org_jwt_idp_output(idp_id: pulumi.Input[Optional[_builtins.str]] = None,
                           org_id: pulumi.Input[Optional[_builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgJwtIdpResult]:
    """
    Datasource representing a generic JWT IdP on the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgJwtIdp:getOrgJwtIdp', __args__, opts=opts, typ=GetOrgJwtIdpResult)
    return __ret__.apply(lambda __response__: GetOrgJwtIdpResult(
