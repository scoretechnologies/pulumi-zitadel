...
class InstanceMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: List of roles granted. Instance member roles must start with 'IAM*' (e.g., IAM*OWNER, IAM*OWNER*VIEWER). See https://zitadel.com/docs/guides/manage/console/administrators for available roles.
...
@pulumi.type_token("zitadel:index/instanceMember:InstanceMember")
class InstanceMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            roles: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            user_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'InstanceMember':
        """
