...
def get_idp_ldap(id: Optional[_builtins.str] = None,
...
def get_idp_ldap_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdpLdapResult]:
    """
    Datasource representing an LDAP IDP on the instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getIdpLdap:getIdpLdap', __args__, opts=opts, typ=GetIdpLdapResult)
    return __ret__.apply(lambda __response__: GetIdpLdapResult(
