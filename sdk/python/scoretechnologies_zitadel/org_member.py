...
class OrgMemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] roles: List of roles granted. Organization member roles must start with 'ORG*' (e.g., ORG*OWNER, ORG*USER*MANAGER). See https://zitadel.com/docs/guides/manage/console/administrators for available roles.
...
@pulumi.type_token("zitadel:index/orgMember:OrgMember")
class OrgMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            roles: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            user_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'OrgMember':
        """
