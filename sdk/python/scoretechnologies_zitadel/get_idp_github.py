...
def get_idp_github(id: Optional[_builtins.str] = None,
...
def get_idp_github_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdpGithubResult]:
    """
    Datasource representing a GitHub IDP on the instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getIdpGithub:getIdpGithub', __args__, opts=opts, typ=GetIdpGithubResult)
    return __ret__.apply(lambda __response__: GetIdpGithubResult(
