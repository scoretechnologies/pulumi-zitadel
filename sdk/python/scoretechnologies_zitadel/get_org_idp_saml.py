...
def get_org_idp_saml(id: Optional[_builtins.str] = None,
...
def get_org_idp_saml_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                            org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpSamlResult]:
    """
    Datasource representing a SAML IdP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpSaml:getOrgIdpSaml', __args__, opts=opts, typ=GetOrgIdpSamlResult)
    return __ret__.apply(lambda __response__: GetOrgIdpSamlResult(
