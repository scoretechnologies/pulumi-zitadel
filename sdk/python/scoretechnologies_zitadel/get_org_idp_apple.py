...
__all__ = [
    'GetOrgIdpAppleResult',
    'AwaitableGetOrgIdpAppleResult',
    'get_org_idp_apple',
    'get_org_idp_apple_output',
]

@pulumi.output_type
class GetOrgIdpAppleResult:
    """
    A collection of values returned by getOrgIdpApple.
    """
    def __init__(__self__, auto_linking=None, client_id=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, key_id=None, name=None, org_id=None, scopes=None, team_id=None):
...
class AwaitableGetOrgIdpAppleResult(GetOrgIdpAppleResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrgIdpAppleResult(
...
def get_org_idp_apple(id: Optional[_builtins.str] = None,
                      org_id: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrgIdpAppleResult:
    """
    ...
    default = zitadel.get_org_idp_apple(id="123456789012345678",
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getOrgIdpApple:getOrgIdpApple', __args__, opts=opts, typ=GetOrgIdpAppleResult).value

    return AwaitableGetOrgIdpAppleResult(
...
def get_org_idp_apple_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                             org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpAppleResult]:
    """
    Datasource representing an Apple IDP on the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpApple:getOrgIdpApple', __args__, opts=opts, typ=GetOrgIdpAppleResult)
    return __ret__.apply(lambda __response__: GetOrgIdpAppleResult(
