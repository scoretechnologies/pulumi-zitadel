...
class GetOrgIdpGitlabSelfHostedResult:
    ...
    """
    def __init__(__self__, auto_linking=None, client_id=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, issuer=None, name=None, org_id=None, scopes=None):
...
def get_org_idp_gitlab_self_hosted(id: Optional[_builtins.str] = None,
...
def get_org_idp_gitlab_self_hosted_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                                          org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpGitlabSelfHostedResult]:
    """
    Datasource representing a GitLab Self Hosted IdP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpGitlabSelfHosted:getOrgIdpGitlabSelfHosted', __args__, opts=opts, typ=GetOrgIdpGitlabSelfHostedResult)
    return __ret__.apply(lambda __response__: GetOrgIdpGitlabSelfHostedResult(
