...
class GetOrgIdpOauthResult:
    ...
    """
    def __init__(__self__, authorization_endpoint=None, auto_linking=None, client_id=None, id=None, id_attribute=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, name=None, org_id=None, scopes=None, token_endpoint=None, use_pkce=None, user_endpoint=None):
...
def get_org_idp_oauth(id: Optional[_builtins.str] = None,
...
def get_org_idp_oauth_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                             org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpOauthResult]:
    """
    Datasource representing a generic OAuth2 IDP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpOauth:getOrgIdpOauth', __args__, opts=opts, typ=GetOrgIdpOauthResult)
    return __ret__.apply(lambda __response__: GetOrgIdpOauthResult(
