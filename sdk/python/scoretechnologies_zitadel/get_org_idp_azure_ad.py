...
class GetOrgIdpAzureAdResult:
    ...
    """
    def __init__(__self__, auto_linking=None, client_id=None, email_verified=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, name=None, org_id=None, scopes=None, tenant_id=None, tenant_type=None):
...
def get_org_idp_azure_ad(id: Optional[_builtins.str] = None,
...
def get_org_idp_azure_ad_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                                org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpAzureAdResult]:
    """
    Datasource representing an Azure AD IdP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpAzureAd:getOrgIdpAzureAd', __args__, opts=opts, typ=GetOrgIdpAzureAdResult)
    return __ret__.apply(lambda __response__: GetOrgIdpAzureAdResult(
        ...
        tenant_type=pulumi.get(__response__, 'tenant_type')))
