...
def get_projects_output(name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult)
