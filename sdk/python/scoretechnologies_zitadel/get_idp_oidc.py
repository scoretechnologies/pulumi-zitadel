...
class GetIdpOidcResult:
    ...
    """
    def __init__(__self__, auto_linking=None, client_id=None, client_secret=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_id_token_mapping=None, is_linking_allowed=None, issuer=None, name=None, scopes=None):
...
def get_idp_oidc(id: Optional[str] = None,
...
@_utilities.lift_output_func(get_idp_oidc)
def get_idp_oidc_output(id: Optional[pulumi.Input[str]] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIdpOidcResult]:
    """
    Datasource representing a generic OIDC IdP on the instance.
