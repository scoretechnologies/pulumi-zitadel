...
__all__ = [
    'GetIdpOidcResult',
    'AwaitableGetIdpOidcResult',
    'get_idp_oidc',
    'get_idp_oidc_output',
]

@pulumi.output_type
class GetIdpOidcResult:
    """
    A collection of values returned by getIdpOidc.
    """
    def __init__(__self__, auto_linking=None, client_id=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_id_token_mapping=None, is_linking_allowed=None, issuer=None, name=None, scopes=None, use_pkce=None):
...
class AwaitableGetIdpOidcResult(GetIdpOidcResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIdpOidcResult(
...
def get_idp_oidc(id: Optional[_builtins.str] = None,
                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIdpOidcResult:
    """
    ...
    default = zitadel.get_idp_oidc(id="123456789012345678")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('zitadel:index/getIdpOidc:getIdpOidc', __args__, opts=opts, typ=GetIdpOidcResult).value

    return AwaitableGetIdpOidcResult(
...
def get_idp_oidc_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdpOidcResult]:
    """
    Datasource representing a generic OIDC IdP on the instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getIdpOidc:getIdpOidc', __args__, opts=opts, typ=GetIdpOidcResult)
    return __ret__.apply(lambda __response__: GetIdpOidcResult(
