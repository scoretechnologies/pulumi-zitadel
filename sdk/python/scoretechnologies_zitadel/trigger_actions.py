...
class TriggerActionsArgs:
    def __init__(__self__, *,
                 action_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 flow_type: pulumi.Input[_builtins.str],
                 trigger_type: pulumi.Input[_builtins.str],
                 org_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a TriggerActions resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] action_ids: IDs of the triggered actions
        :param pulumi.Input[_builtins.str] flow_type: Type of the flow to which the action triggers belong, supported values: FLOW*TYPE*EXTERNAL*AUTHENTICATION, FLOW*TYPE*CUSTOMISE*TOKEN, FLOW*TYPE*INTERNAL*AUTHENTICATION, FLOW*TYPE*SAML*RESPONSE
        :param pulumi.Input[_builtins.str] trigger_type: Trigger type on when the actions get triggered, supported values: TRIGGER*TYPE*POST*AUTHENTICATION, TRIGGER*TYPE*PRE*CREATION, TRIGGER*TYPE*POST*CREATION, TRIGGER*TYPE*PRE*USERINFO*CREATION, TRIGGER*TYPE*PRE*ACCESS*TOKEN*CREATION, TRIGGER*TYPE*PRE*SAML*RESPONSE_CREATION
    ...
    def action_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @action_ids.setter
    def action_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "action_ids", value)

    @_builtins.property
    @pulumi.getter(name="flowType")
    def flow_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @flow_type.setter
    def flow_type(self, value: pulumi.Input[_builtins.str]):
...
class _TriggerActionsState:
    def __init__(__self__, *,
                 ...
                 flow_type: pulumi.Input[Optional[_builtins.str]] = None,
                 org_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="flowType")
    def flow_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Type of the flow to which the action triggers belong, supported values: FLOW*TYPE*EXTERNAL*AUTHENTICATION, FLOW*TYPE*CUSTOMISE*TOKEN, FLOW*TYPE*INTERNAL*AUTHENTICATION, FLOW*TYPE*SAML*RESPONSE
        """
        return pulumi.get(self, "flow_type")
    ...
    @flow_type.setter
    def flow_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "flow_type", value)
...
@pulumi.type_token("zitadel:index/triggerActions:TriggerActions")
class TriggerActions(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            flow_type: pulumi.Input[Optional[_builtins.str]] = None,
            org_id: pulumi.Input[Optional[_builtins.str]] = None,
            trigger_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'TriggerActions':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="actionIds")
    def action_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        IDs of the triggered actions
        """
        return pulumi.get(self, "action_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="flowType")
    def flow_type(self) -> pulumi.Output[_builtins.str]:
        """
        Type of the flow to which the action triggers belong, supported values: FLOW*TYPE*EXTERNAL*AUTHENTICATION, FLOW*TYPE*CUSTOMISE*TOKEN, FLOW*TYPE*INTERNAL*AUTHENTICATION, FLOW*TYPE*SAML*RESPONSE
        """
        return pulumi.get(self, "flow_type")
