...
def get_application_oidcs(name: Optional[_builtins.str] = None,
...
def get_application_oidcs_output(name: pulumi.Input[Optional[_builtins.str]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplicationOidcsResult]:
    """
    Datasource representing multiple OIDC applications belonging to a project.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getApplicationOidcs:getApplicationOidcs', __args__, opts=opts, typ=GetApplicationOidcsResult)
    return __ret__.apply(lambda __response__: GetApplicationOidcsResult(
