...
class GetTriggerActionsResult:
    ...
    def action_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def flow_type(self) -> _builtins.str:
        """
...
def get_trigger_actions(flow_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str flow_type: Type of the flow to which the action triggers belong
    ...
    :param _builtins.str trigger_type: Trigger type on when the actions get triggered
    """
    __args__ = dict()
...
def get_trigger_actions_output(flow_type: pulumi.Input[Optional[_builtins.str]] = None,
                               org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               trigger_type: pulumi.Input[Optional[_builtins.str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTriggerActionsResult]:
    """
    Resource representing triggers, when actions get started
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getTriggerActions:getTriggerActions', __args__, opts=opts, typ=GetTriggerActionsResult)
    return __ret__.apply(lambda __response__: GetTriggerActionsResult(
        action_ids=pulumi.get(__response__, 'action_ids'),
