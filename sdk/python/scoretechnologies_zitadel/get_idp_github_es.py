...
class GetIdpGithubEsResult:
    ...
    """
    def __init__(__self__, authorization_endpoint=None, auto_linking=None, client_id=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, name=None, scopes=None, token_endpoint=None, user_endpoint=None):
...
def get_idp_github_es(id: Optional[_builtins.str] = None,
...
def get_idp_github_es_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdpGithubEsResult]:
    """
    Datasource representing a GitHub Enterprise IDP on the instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getIdpGithubEs:getIdpGithubEs', __args__, opts=opts, typ=GetIdpGithubEsResult)
    return __ret__.apply(lambda __response__: GetIdpGithubEsResult(
