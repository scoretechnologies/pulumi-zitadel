...
def get_application_api(app_id: Optional[_builtins.str] = None,
...
def get_application_api_output(app_id: pulumi.Input[Optional[_builtins.str]] = None,
                               org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               project_id: pulumi.Input[Optional[_builtins.str]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplicationApiResult]:
    """
    Datasource representing an API application belonging to a project, with all configuration possibilities.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getApplicationApi:getApplicationApi', __args__, opts=opts, typ=GetApplicationApiResult)
    return __ret__.apply(lambda __response__: GetApplicationApiResult(
