...
class GetOrgIdpGoogleResult:
    ...
    """
    def __init__(__self__, auto_linking=None, client_id=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, name=None, org_id=None, scopes=None):
...
def get_org_idp_google(id: Optional[_builtins.str] = None,
...
def get_org_idp_google_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                              org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgIdpGoogleResult]:
    """
    Datasource representing a Google IdP of the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgIdpGoogle:getOrgIdpGoogle', __args__, opts=opts, typ=GetOrgIdpGoogleResult)
    return __ret__.apply(lambda __response__: GetOrgIdpGoogleResult(
