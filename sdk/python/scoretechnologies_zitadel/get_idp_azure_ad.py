...
class GetIdpAzureAdResult:
    ...
    """
    def __init__(__self__, auto_linking=None, client_id=None, email_verified=None, id=None, is_auto_creation=None, is_auto_update=None, is_creation_allowed=None, is_linking_allowed=None, name=None, scopes=None, tenant_id=None, tenant_type=None):
...
def get_idp_azure_ad(id: Optional[_builtins.str] = None,
...
def get_idp_azure_ad_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdpAzureAdResult]:
    """
    Datasource representing an Azure AD IDP on the instance.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getIdpAzureAd:getIdpAzureAd', __args__, opts=opts, typ=GetIdpAzureAdResult)
    return __ret__.apply(lambda __response__: GetIdpAzureAdResult(
