...
def get_org_oidc_idp(id: Optional[_builtins.str] = None,
...
def get_org_oidc_idp_output(id: pulumi.Input[Optional[_builtins.str]] = None,
                            org_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrgOidcIdpResult]:
    """
    Datasource representing a generic OIDC IdP on the organization.
    ...
    __ret__ = pulumi.runtime.invoke_output('zitadel:index/getOrgOidcIdp:getOrgOidcIdp', __args__, opts=opts, typ=GetOrgOidcIdpResult)
    return __ret__.apply(lambda __response__: GetOrgOidcIdpResult(
