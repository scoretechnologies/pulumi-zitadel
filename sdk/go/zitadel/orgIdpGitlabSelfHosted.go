...
// Name of the IDP
func (o OrgIdpGitlabSelfHostedOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpGitlabSelfHosted) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}
