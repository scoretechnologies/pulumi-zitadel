...
// Name of the IDP
func (o OrgIdpAzureAdOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpAzureAd) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}
