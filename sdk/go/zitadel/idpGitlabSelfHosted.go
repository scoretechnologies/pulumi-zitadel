...
// Name of the IDP
func (o IdpGitlabSelfHostedOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *IdpGitlabSelfHosted) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}
