...
// Name of the IDP
func (o OrgIdpGithubEsOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *OrgIdpGithubEs) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}
