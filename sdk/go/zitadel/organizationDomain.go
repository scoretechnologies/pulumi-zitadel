...
// OrganizationDomainMapInput is an input type that accepts OrganizationDomainMap and OrganizationDomainMapOutput values.
// You can construct a concrete instance of `OrganizationDomainMapInput` via:
//
//	OrganizationDomainMap{ "key": OrganizationDomainArgs{...} }
type OrganizationDomainMapInput interface {
	pulumi.Input

	ToOrganizationDomainMapOutput() OrganizationDomainMapOutput
	ToOrganizationDomainMapOutputWithContext(context.Context) OrganizationDomainMapOutput
}

type OrganizationDomainMap map[string]OrganizationDomainInput

func (OrganizationDomainMap) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*OrganizationDomain)(nil)).Elem()
}

func (i OrganizationDomainMap) ToOrganizationDomainMapOutput() OrganizationDomainMapOutput {
	return i.ToOrganizationDomainMapOutputWithContext(context.Background())
}

func (i OrganizationDomainMap) ToOrganizationDomainMapOutputWithContext(ctx context.Context) OrganizationDomainMapOutput {
	return pulumi.ToOutputWithContext(ctx, i).(OrganizationDomainMapOutput)
}
...
type OrganizationDomainMapOutput struct{ *pulumi.OutputState }

func (OrganizationDomainMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]*OrganizationDomain)(nil)).Elem()
}

func (o OrganizationDomainMapOutput) ToOrganizationDomainMapOutput() OrganizationDomainMapOutput {
	return o
}

func (o OrganizationDomainMapOutput) ToOrganizationDomainMapOutputWithContext(ctx context.Context) OrganizationDomainMapOutput {
	return o
}

func (o OrganizationDomainMapOutput) MapIndex(k pulumi.StringInput) OrganizationDomainOutput {
	return pulumi.All(o, k).ApplyT(func(vs []interface{}) *OrganizationDomain {
		return vs[0].(map[string]*OrganizationDomain)[vs[1].(string)]
	}).(OrganizationDomainOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*OrganizationDomainMapInput)(nil)).Elem(), OrganizationDomainMap{})
	pulumi.RegisterOutputType(OrganizationDomainOutput{})
	pulumi.RegisterOutputType(OrganizationDomainArrayOutput{})
	pulumi.RegisterOutputType(OrganizationDomainMapOutput{})
}
